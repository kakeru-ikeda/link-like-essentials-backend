...
**利用可能な限定区分**: `PERMANENT`, `LIMITED`, `SPRING_LIMITED`, `SUMMER_LIMITED`, `AUTUMN_LIMITED`, `WINTER_LIMITED`, `BIRTHDAY_LIMITED`, `LEG_LIMITED`, `BATTLE_LIMITED`, `PARTY_LIMITED`, `ACTIVITY_LIMITED`, `BANGDREAM_LIMITED`, `GRADUATE_LIMITED`, `LOGIN_BONUS`, `REWARD`
